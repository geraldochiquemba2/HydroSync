...
import { Landmark, TrendingUp, Lightbulb, Tractor, Wallet, ArrowRight, ShieldCheck, Zap, Globe, Sparkles } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Button variant="ghost" size="sm" className="text-blue-600 text-xs font-bold uppercase">Ver Todos</Button>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {/* BAI Card */}
                        <Card className="border-0 shadow-lg hover:shadow-xl transition-all cursor-pointer group bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
                            <CardHeader className="pb-2">
                                <div className="flex justify-between items-start">
                                    ...
                                    <Badge className="bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400">PNA Aberto</Badge>
                                </div>
                                <CardTitle className="text-lg mt-4 group-hover:text-blue-600 transition-colors">Banco BAI: Plano Nacional</CardTitle>
                                <CardDescription className="text-xs text-slate-500">Linha de crédito para cereais 2026</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="flex justify-between text-xs font-medium">
                                    <span className="text-slate-500">Taxa de Juro</span>
                                    <span className="text-slate-900 dark:text-slate-100">7.5% - 9%</span>
                                </div>
                                <div className="space-y-1">
                                    ...
                                    <Progress value={68} className="h-1.5 bg-slate-100 dark:bg-slate-800" indicatorClassName="bg-blue-600" />
                                </div>
                            </CardContent>
                        ...
                        <Card className="border-0 shadow-lg hover:shadow-xl transition-all cursor-pointer group bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
                            <CardHeader className="pb-2">
                                <div className="flex justify-between items-start">
                                    <div className="p-2 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-100 dark:border-amber-800">
                                        <Tractor className="w-6 h-6 text-amber-600" />
                                    </div>
                                    <Badge className="bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400">Mecanização</Badge>
                                </div>
                                <CardTitle className="text-lg mt-4 group-hover:text-amber-600 transition-colors">FADA: Fundo Agrário</CardTitle>
                                <CardDescription className="text-xs text-slate-500">Apoio à mecanização e colheitas</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="flex justify-between text-xs font-medium">
                                    <span className="text-slate-500">Prazo de Resposta</span>
                                    <span className="text-slate-900 dark:text-slate-100">15 Dias Úteis</span>
                                </div>
                                <div className="space-y-1">
                                    <div className="flex justify-between text-[10px] uppercase font-bold text-slate-400">
                                        <span>Fundos Alocados</span>
                                        <span>42%</span>
                                    </div>
                                    <Progress value={42} className="h-1.5 bg-slate-100 dark:bg-slate-800" indicatorClassName="bg-amber-500" />
                                </div>
                            </CardContent>
                            <CardFooter className="pt-0 flex justify-end">
                ...
                <div className="space-y-6">
                    <Card className="bg-slate-900 border border-white/10 text-white shadow-2xl relative overflow-hidden">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="pt-4 border-t border-white/10">
                                <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-6 text-sm gap-2 font-bold shadow-lg shadow-blue-500/20">
                    ...
                    <Card className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl p-6">
                        ...
                        <Button variant="outline" className="w-full text-xs font-bold uppercase tracking-tight gap-2">
                            Explorar Cadeia de Valor <ArrowRight className="w-3 h-3" />
                        </Button>
                    </Card>
                </div>
            </div>
